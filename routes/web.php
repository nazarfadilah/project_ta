...
Route::post('/register/verify', [AuthController::class, 'verifyRegister'])->name('register.verify.process');
Route::post('/register/verify/resend', [AuthController::class, 'resendVerifyRegister'])->name('register.verify.resend');
