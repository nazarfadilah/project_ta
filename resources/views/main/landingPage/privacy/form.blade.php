...
@section('title', $mode === 'create' ? 'Tambah Kebijakan & Privasi' : 'Edit Kebijakan & Privasi')
    ...
    <div class="card border-0 shadow-sm rounded-3">
        <div class="card-header" style="background-color: #C9A961; color: #fff; border-radius: 8px 8px 0 0; padding: 14px 20px;">
            <h6 class="mb-0 fw-semibold" style="font-size: 15px;">
                <i class="fas fa-shield-alt me-2"></i>{{ $mode === 'create' ? 'Tambah Kebijakan & Privasi Baru' : 'Edit Kebijakan & Privasi' }}
            </h6>
        </div>
        <div class="card-body" style="padding: 30px;">
            <form action="{{ $mode === 'create' ? route('main.landing.privacy.store') : route('main.landing.privacy.update', $privacy->id) }}" 
                  method="POST" 
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea id="value" 
                                  ...
                                  rows="8"
                                  style="border-radius: 5px; border: 1px solid #ddd; padding: 10px; font-size: 14px;"
                                  required>{{ old('value', $privacy?->value ?? '') }}</textarea>
                        @error('value')
                            <div class="invalid-feedback" style="display: block; font-size: 13px;">
                                {{ $message }}
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div style="display: flex; gap: 10px;">
                            ...
                            <a href="{{ route('main.landing.privacy.index') }}" class="btn btn-secondary" style="padding: 10px 20px; border-radius: 5px; border: none; font-size: 14px; font-weight: 500;">
