    ...
    <div class="card border-0 shadow-sm rounded-3">
        <div class="card-header d-flex align-items-center justify-content-between" style="background-color: #C9A961; color: #fff; border-radius: 8px 8px 0 0; padding: 14px 20px;">
            <h6 class="mb-0 fw-semibold" style="font-size: 15px;">
                <i class="fas fa-info-circle me-2"></i>Daftar Tentang
            </h6>
            <a href="{{ route('main.landing.tentang.create') }}" class="btn btn-sm btn-light" style="font-size: 13px; padding: 6px 12px;">
                <i class="fas fa-plus me-1"></i> Tambah Data
            </a>
        </div>
        <div class="card-body" style="padding: 20px;">
            <div class="table-responsive">
                <table id="tentangTable" class="table table-hover table-bordered align-middle" style="width: 100%; font-size: 14px;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <a href="{{ route('main.landing.tentang.edit', $item->id) }}" 
                                ...
                                <button class="btn btn-sm btn-danger" 
                                        title="Delete"
                                        onclick="hapusData('{{ route('main.landing.tentang.destroy', $item->id) }}')"
                                        style="padding: 4px 10px; font-size: 13px;">
...
<style>
    #tentangTable thead th {
        font-weight: 600;
        font-size: 13px;
        color: #555;
        border-bottom: 2px solid #dee2e6;
    }
    #tentangTable tbody td {
        vertical-align: middle;
        color: #444;
    }
    #tentangTable tbody tr:hover {
