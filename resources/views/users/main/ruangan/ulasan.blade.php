...
<div class="container-fluid" style="padding-left: 20px; padding-right: 20px; margin-top: 20px;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <a href="{{ route('users.main.ruangan.show', str_replace(' ', '-', strtolower($ruangan->nama_ruangan))) }}" class="btn btn-secondary btn-sm">
        ...
        <div class="card-body p-4" style="background-color: #fcfcfc;">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="text-muted mb-0" style="font-size: 14px;">Berikut adalah ulasan lengkap yang diberikan oleh tamu setelah menggunakan ruangan ini.</p>
                </div>
                            ...
                            @if($review->foto_ulasan)
                                <div class="mt-2" style="max-width: 250px; aspect-ratio: 1.5; border-radius: 8px; overflow: hidden; border: 1px solid #ddd;">
                                    <a href="{{ asset($review->foto_ulasan) }}" data-lightbox="review-gallery-all-{{ $review->id }}">
                                        <img src="{{ asset($review->foto_ulasan) }}" alt="Foto ulasan" class="w-100 h-100 object-fit-cover hover-zoom">
                                    </a>
                                </div>
                            @endif
                        </div>
