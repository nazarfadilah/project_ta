    ...
    <div class="container">
      ...
      <div class="pricing-grid" id="pricingGrid">
        ...
        <div class="pricing-card">
          ...
          <a href="{{ route('users.main.reservasi.create') }}" class="pricing-btn" id="pricingStd">Pesan Sekarang</a>
        </div>
        ...
        <div class="pricing-card popular">
          ...
          <a href="{{ route('users.main.reservasi.create') }}" class="pricing-btn popular-btn" id="pricingVip">Pesan Sekarang</a>
        </div>
        ...
        <div class="pricing-card">
          ...
          <a href="{{ route('users.main.reservasi.create') }}" class="pricing-btn" id="pricingAula">Hubungi Kami</a>
        </div>
