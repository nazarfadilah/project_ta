    ...
    public function run(): void
    {
        ...
        $beritas = [
            [
                ...
                'gambar' => 'https://via.placeholder.com/500x300?text=Pelayanan+Pendaftaran',
            ...
            [
                ...
                'gambar' => 'https://via.placeholder.com/500x300?text=Tips+Persiapan',
            ...
            [
                ...
                'gambar' => 'https://via.placeholder.com/500x300?text=Pemberitahuan+Libur',
            ...
            [
                ...
                'isi' => 'Banyak calon jamaah haji yang telah merasakan manfaat fasilitas dan pelayanan kami. Berikut adalah beberapa testimoni positif dari mereka yang telah mendaftar dan bersiap untuk menunaikan ibadah haji tahun lalu.',
                'gambar' => 'https://via.placeholder.com/500x300?text=Testimoni+Jamaah',
            ...
            [
                ...
                'gambar' => 'https://via.placeholder.com/500x300?text=Syarat+Ketentuan',
            ...
            [
                ...
                'gambar' => 'https://via.placeholder.com/500x300?text=Program+Edukasi',
            ...
            [
                ...
                'gambar' => 'https://via.placeholder.com/500x300?text=Fasilitas+Baru',
            ...
            [
                ...
                'gambar' => 'https://via.placeholder.com/500x300?text=Panduan+Pembayaran',
