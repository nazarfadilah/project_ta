...
class SaranaSeeder extends Seeder {
    public function run(): void {
        ...
        DB::table('sarana')->insert([
            ...
            ['id' => 5, 'nama' => 'Kasur Lipat Busa', 'kondisi' => 'Baik', 'tgl_penerimaan' => '2026-01-20', 'stok' => '80'],
            ...
            ['id' => 9, 'nama' => 'Papan Tulis Whiteboard Stand', 'kondisi' => 'Baik', 'tgl_penerimaan' => '2026-01-05', 'stok' => '15'],
